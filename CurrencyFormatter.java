...
public class CurrencyFormatter {
	...
	public static void main(String[] args) {
        ...
        Locale chinaLocale = new Locale("yn", "CN");
        ...
        numberFormat =  NumberFormat.getCurrencyInstance(java.util.Locale.CHINA);
        String china = numberFormat.format(payment);
        
        numberFormat = NumberFormat.getCurrencyInstance(franceLocale);
